    ...
    <div className="login-container">
      <form action="" className="form_main">
        ...
        <div className="inputContainer">
          ...
          <input type="text" className="inputField" id="username" placeholder="Full name" />
        </div>
        ...
        <div className="inputContainer">
          ...
          <input type="password" className="inputField" id="password" placeholder="Confirm Password" />
        </div>

        <button id="button">Submit</button>
        <a className="signupLink" href="/login">Already have an account? Login</a>
      </form>
    </div>
